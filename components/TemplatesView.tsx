...
import { HIRO_TEMPLATES } from '@/service/hiroTemplates';
        ...
        <div className="max-w-7xl mx-auto px-6 py-12 space-y-12 animate-fade-in">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
                    ...
                    <div className="relative w-full md:w-96">
                        ...
                        <input
                            ...
                            className={`w-full pl-12 pr-4 py-4 border-2 font-mono text-sm focus:outline-none transition-all shadow-neo-sm focus:shadow-neo ${isDark ? 'bg-black border-gray-800 text-white' : 'bg-white border-black text-black'
                                }`}
                        />
                    </div>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {filteredTemplates.map((template) => (
                    <div
                        key={template.id}
                        className={`p-8 border-2 shadow-neo transition-all hover:-translate-y-1 group flex flex-col ${isDark ? 'bg-[#111] border-gray-800' : 'bg-white border-black'
                            }`}
                    >
